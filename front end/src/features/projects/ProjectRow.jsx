...
//   <Table.Row >
//     <td>{index + 1}</td>
//     <td>{truncateText(projects.title , 20)}</td>
//     <td>{projects.category.title}</td>
//     <td>{toPersianNumbersWithComma(projects.budget)}</td>
...
//      </div>
//    </td>
//    <td>{projects.freelancer?.name || "-"}</td>
//    <td>
...
//       <TbPencilMinus className="w-5 h-5 text-primary-500"/>
//       <Modal open={isEditOpen} 
//       title={ `  ویرایش ${projects.title}`} 
...
//        title={ ` حذف ${projects.title}`} 
//         onClose={()=> setIsDeleteOpen(false)}>
//       <ConfirmDelete
//       Resoursename={projects.title}
//       onClose={()=> setIsDeleteOpen(false)}
//       onConfirm={()=>{}}
//       disabled={flase}
//       />
